...
function ComingSoon({ projectName }) {
    return (
        <div className="w-full text-center py-20 pt-48 bg-olivewhite min-h-screen">
            <h1 className="text-4xl font-bold text-h1 font-ppSupply">Coming Soon: {projectName}</h1>
