    ...
    return (
        <div className="relative bg-olive">
            ...
            <div className="container mx-auto">
                {/* Hero Section */}
                <div className="relative p-16 mt-24 flex items-center justify-center bg-sage text-ink p-8">
                    <div className="flex flex-col  md:flex-row items-center md:items-start md:space-x-8 text-center md:text-left z-20 mb-12">
                        ...
                        <div className="text-left">
                            <h1 className="sm:text-h1 md:text-h1 lg:text-8xl font-bold font-syne tracking-wide mt-12 md:mt-0">
                                WORK & PROJECTS
                            </h1>
