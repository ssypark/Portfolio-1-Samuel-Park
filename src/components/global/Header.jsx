...
function Header() {
    ...
    useEffect(() => {
        ...
        if (currentPath.startsWith("/work")) {
            activePath = "/work";
        } else if (currentPath.startsWith("/art")) {
            activePath = "/art";
        } else if (currentPath.startsWith("/about")) {
            activePath = "/about";
        }
        
        const activeRef = linkRefs[activePath];
    ...
    return (
        <header
            className={`fixed w-full z-[200] transition-all duration-300 border-t border-b border-ink ${isScrolled
                            ...
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    isActive || location.pathname.startsWith("/work/") 
                                        ? "text-ink px-4 py-1 rounded-full active" 
                                        : "text-ink px-4 py-1 rounded-full hover:text-redOrange"
                                }
                            >
                                Work
                            </NavLink>
